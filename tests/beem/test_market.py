...
class Testcases(unittest.TestCase):
    ...
    def test_ticker(self):
        bts = self.bts
        m = Market("HIVE:HBD", steem_instance=bts)
        ticker = m.ticker()
        ...
        if "hive_volume" in ticker:
            ...
            self.assertEqual(ticker["steem_volume"]["symbol"], "HIVE")
            self.assertEqual(ticker["sbd_volume"]["symbol"], "HBD")
    ...
    def test_buy(self):
        ...
        p = Price(5, "HBD:HIVE", steem_instance=bts)
