...
class Testcases(unittest.TestCase):
    ...
    def test_changerecovery(self):
        ...
        result = runner.invoke(
            cli, ["-dx", "changerecovery", "-a", "beembot", "holger80"], input=wif + "\nexit\n"
        )
        self.assertEqual(result.exit_code, 0)
    ...
    def test_transfer(self):
        ...
        result = runner.invoke(
            cli,
            ["-dx", "transfer", "beembot", "1", stm.backed_token_symbol, "test"],
            input="test\n",
        )
        self.assertEqual(result.exit_code, 0)
    ...
    def test_allow_disallow(self):
        ...
        result = runner.invoke(
            cli,
            ["-dx", "allow", "--account", "beembot", "--permission", "posting", "beempy"],
            input="test\n",
        )
        self.assertEqual(result.exit_code, 0)
        result = runner.invoke(
            cli,
            ["-dx", "disallow", "--account", "holger80", "--permission", "posting", "rewarding"],
            input="test\n",
        )
        self.assertEqual(result.exit_code, 0)
    ...
    def test_approvewitness(self):
        runner = CliRunner()
        result = runner.invoke(
            cli, ["-dx", "approvewitness", "-a", "beempy", "holger80"], input="test\n"
        )
        self.assertEqual(result.exit_code, 0)
    ...
    def test_disapprovewitness(self):
        runner = CliRunner()
        result = runner.invoke(
            cli, ["-dx", "disapprovewitness", "-a", "beempy", "holger80"], input="test\n"
        )
        self.assertEqual(result.exit_code, 0)
    ...
    def test_importaccount(self):
        ...
        result = runner.invoke(
            cli,
            ["importaccount", "--roles", '["owner", "active", "posting", "memo"]', "beem2"],
    ...
    def test_witnessenable(self):
        runner = CliRunner()
        result = runner.invoke(
            cli, ["-dx", "witnessenable", "holger80", "STM1111111111111111111111111111111114T1Anm"]
        )
        self.assertEqual(result.exit_code, 0)
